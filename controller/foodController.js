...
const foodController = {
  ...
  postEditFoodById: async (req, res) => {
    try {
      const foodId = req.params.foodId;
      const foodData = req.body;
  ...
  postDeleteFoodById: async (req, res) => {
    try {
