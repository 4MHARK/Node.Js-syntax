...
postCreateNewHotel: async (req, res) => {
    try {
...
postEditHotelById: async (req, res) => {
   try {
...
getDeleteHotelById : async (req, res) => {
    try {
      const hotelId = req.params.id;
...
getWalkingBooking:  async (req, res) => {
  try {
    const { hotelId } = req.params;
...
getRoomsByRoomTypeId : async (req, res) => {
    try {
      const successMsg = req.flash("success")[0];
      const errorMsg = req.flash("error")[0];
...
getRoomsOnRoomtypeID: async (req, res) => {
  try {
...
getDeleteRoomById: async (req, res) => {
    try {
      const roomId = req.params.roomId;
      // Find the room by ID
      const room = await Room.findById(roomId);
...
getCreateRoomByRoomTyeID: async (req, res) => {
    const successMsg = req.flash("success")[0];
    const errorMsg = req.flash("error")[0];
...
postCreateRoomByRoomTypeID:   async (req, res) => {
    try {
...
getDeleteRoomTypeByHotelID: async (req, res) => {
    try {
...
getShowRoomTypeByHotelID:   async (req, res) => {
    try {
      const successMsg = req.flash("success")[0];
      const errorMsg = req.flash("error")[0];
...
getCreateRoomTypeByHotelID:   async (req, res) => {
    const successMsg = req.flash("success")[0];
    const errorMsg = req.flash("error")[0];
...
postAddRoomTypeByHotelID: async (req, res) => {
...
getEditRoomTypeByID: async (req, res) => {
    const successMsg = req.flash("success")[0];
    const errorMsg = req.flash("error")[0];
...
postEditRoomTypeByID: async (req, res) => {
  const roomId = req.params.roomId;
  const hotelId = req.params.hotelId;
  try {
    // Find the corresponding hotel based on the hotelId
...
getSearchCustomerByID:  async (req, res) => {
    try {
...
postSearchOrders :  async (req, res) => {
    const user = req.user;
    const hotelIds = user.hotels;
...
postCreateInvoice:   async (req, res) => {
    try {
...
getSelectRoomsAvailable:  async (req, res) => {
    try {
      const errorMsg = req.flash("error")[0];
      const successMsg = req.flash("success")[0];
...
postCheckinAavailableRooms: async (req, res) => {
...
getRoomTypeByhotelID: async (req, res) => {
  try {
    const hotelId = req.params.hotelId;
...
getHotelDetailsByID: async (req, res) => {
  try {
    const hotelId = req.params.id;
...
postDeleteUserByID: async (req, res) => {
...
postEditUserByID: async (req, res) => {
  const { userId } = req.params;
...
postAssignUserHotelById:  async (req, res) => {
    const { userId } = req.params;
    const { hotels } = req.body;
    try {
      // Find the user by ID
...
postVerifyUserByID:  async (req, res) => {
    try {
