...
router.get('/edit/products/:productId', async (req, res) => {
  try {
...
router.post('/edit/products/:productId', storage({ single: 'productPicture' }), async (req, res) => {
  try {
    const productId = req.params.productId;
    const productData = req.body;
